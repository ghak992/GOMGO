...
<div class="container-fluid">
    ...
    <div class="card card-container" style="max-width: 900px;">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-right" style="float: right">
                <span class="field-title">عدد الطلبات التي تعاملت معها</span>
                <a href="{{URL::to('user/profile/requests-list/'.$id)}}" class="btn btn-sm btn-primary">{{$request[0]->requests_count}}&nbsp;</a>
